...
surface = display.set_mode((600, 500))
...
mainmenu = pygame_menu.Menu('Приветствую', 600, 400, theme=themes.THEME_SOLARIZED)
mainmenu.add.text_input('Ваше имя: ', default='Пользователь', maxchar=20)
